  ...
  return (
    <div className="max-w-[1920px] mx-auto">
      <header className="bg-white shadow-lg  flex w-full dark:bg-[#120505] px-5 md:px-[50px] lg:px-[80px] xl:px-[120px] 2xl:px-[150px]">
        ...
        <div className="relative md:border-l flex items-center  justify-end w-full md:w-auto pl-5">
          <div>
            ...
            >
              <img
                className="md:w-[50px] w-10 object-cover"
      ...
      <div
        className={`absolute ${
          sideOpen ? "" : "hidden"
        } md:hidden  bg-white shadow-lg  w-56 min-h-screen overflow-y-auto top-0 left-0 ease-in-out duration-300 dark:bg-[#120505] dark:text-white`}
      >
        <div className="p-4">
