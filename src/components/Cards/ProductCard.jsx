                  ...
                  <div className="flex-auto justify-evenly">
                    <div className="flex flex-wrap ">
                      <div className="w-full flex-none text-sm flex items-center text-gray-800 dark:text-gray-300">
                        ...
                        <span className="mr-2 text-gray-600 dark:text-gray-300">BD</span>
                      </div>
                    ...
                    <div className="flex space-x-2 text-sm font-medium justify-start mt-5">
                      <button className="transition flex-1 ease-in duration-300 flex items-center text-sm font-medium mb-2 md:mb-0 bg-[#FF497C] px-5 py-1 hover:shadow-lg tracking-wider text-white rounded hover:bg-[#ab3154] text-center justify-center ">
                        <span className="text-center">Add Cart</span>
                        {/* update btn korte conditionally */}
                      </button>
                      <button className="transition flex-1 ease-in duration-300 bg-gray-700 hover:bg-gray-800 border hover:border-gray-500 border-gray-700 hover:text-white  hover:shadow-lg text-white rounded  text-center p-1 flex justify-center items-center px-4 font-medium text-sm">
                       <span className=" mr-2"><i className='bx bxs-low-vision'></i></span>
